...
# the resource provides flexibility to mention these fields/configurations apart from name, tags
# 1. version control,
# 2. lifecycle policies,
# 3. access control,
# 4. server-side encryption  - dynamic
# 5. lifecycle_rule - dynamic

resource "aws_s3_bucket" "s3_bucket" {
  versioning {
    enabled = var.need_versioning
  }
  bucket = "${var.bucket_name}-${var.frequency_of_objects}"
  acl    = var.acl
  policy = var.policy
  ...
  tags = {
    ...
    Frequency = var.frequency_of_objects
  }
}